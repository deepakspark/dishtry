...
<html lang="en-us">
    ...
    <!--****************************** BODY STARTS ****************************************-->
      <body>
          ...
          <p class="heading">Select Service Star Level</p> 
          ...
          <div class="container">   
              <?php     
                    ...
                    {
                        echo(' 
                              <div class="row" onclick="'.$reso['id'].'()" style="border-bottom:1px solid rgb(218,218,218);margin-top:10px;">
                                  <div class="col-xs-10">
                                    <p style="font-size:20px">'.$reso['name'].'</p>
                                  </div>
                                  <div class="col-xs-2">
