      ...
      <body>
       ...
       <div class="upperBar"></div>
          ...
          <div class="menuBar">
                  ...
                  <center><img src="img/home.PNG" width="40px" class="active"></center>
                  </div>
                  
                  <div id="account" class="options" onclick="go3()">
                  <center><img src="img/account.PNG" width="40px"></center>
                  </div>
          </div>
                    ...
                    foreach($dom->xpath("/dishes/dish") as $d){
								if($d['category'] == $_COOKIE['pcatco']){
											...
											if( $_SESSION['checklolo'] == 'absent' ){
											  echo('
											 <div class="row" id="'.$d['srvalue'].'" onclick="'.$d['srvalue'].'(1)" style="border-bottom:1px solid rgb(218,218,218);margin-top:10px;">
													  <div class="col-xs-10">
														  <p style="font-size:19px;">'.$d['usrvalue'].'  '.$d['cost'].'Ru</p>
													   </div>

													  <div class="col-xs-2" id="col-xs-2">
														<img src="img/plus.ico" width="15px" id="'.$d['srvalue'].'img">    
													  </div>
												  </div> 
											');  
										     }
												...
												echo('
												 <div class="row" id="'.$d['srvalue'].'" onclick="'.$d['srvalue'].'(2)" style="border-bottom:1px solid rgb(218,218,218);margin-top:10px;">
													  <div class="col-xs-10">
														  <p style="font-size:19px;">'.$d['usrvalue'].'  '.$d['cost'].'Ru</p>
													  </div>

													  <div class="col-xs-2" id="col-xs-2">
														<img src="img/minus.png" width="15px" id="'.$d['srvalue'].'img">    
													  </div>
												  </div>
											');
											}
