    ...
    <!--****************************** BODY STARTS ****************************************-->
      <body>
          ...
          <div class="menuBar">
                  ...
                  <center><img src="img/account.PNG" width="30px" class="active"></center>
                  </div>
          </div>
          ...
          <p class="heading">Account</p> 
			  ...
			  <p>User: <?php echo($_COOKIE['user']); ?></p>
			  <p>City: <?php echo($_COOKIE['city']); ?></p>
              <p>Area: <?php echo($_COOKIE['area']); ?></p>
          ...
          <div class="jumbotron">
              <div class="container"> 
                    ...
                    <div class="row" onclick="changeadd()">
                          <div class="col-xs-10">
                            <p style="font-size:16px">Change City and Area</p>
                          </div>
                          <div class="col-xs-2">
                            <img src="img/arrow.png" width="11px">
                          </div>
                    ...
                    <div class="row" onclick="">
                          <div class="col-xs-10">
                            <p style="font-size:16px">Term and Conditions</p>
                          </div>
                          <div class="col-xs-2">
                            <img src="img/arrow.png" width="11px">
                          </div>
                     ...
                     <div class="row" onclick="">
                          <div class="col-xs-10">
                            <p style="font-size:16px">About Us</p>
                          </div>
                          <div class="col-xs-2">
                            <img src="img/arrow.png" width="11px">
                          </div>
                     </div>
                     <div class="row" onclick="signOut()">
                          <div class="col-xs-10">
